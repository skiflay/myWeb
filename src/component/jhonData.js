const jhonData = {
  ...
  ptext: "Fullstack JavaScript Developer based in USA.",
  socialLinks: [
    {
      name: "Facebook",
  ...
  contact: [
    {
      ...
      menuItems: [
        ...
        },
        {
          id: 2,
          icon: "icon_phone",
          text: "Phone: +2024467856",
        },
        {
          id: 3,
          icon: "icon_mail",
          text: "Email: szkiflay@gmail.com",
        },
        {
          id: 4,
          icon: "icon_globe",
          text: "Website: http://simonkiflay.com",
        },
      ],
    },
  ],
